...
![Project structure](diagrams/project-structure.jpg)
...
![Layered architecture](diagrams/layered-architecture.jpg)
...
![Request lifecycle for creating a song](diagrams/request-lifecycle.jpg)
...
![Cache read-through flow](diagrams/cache-read-through.jpg)

## Authentication

`ensureAuthenticated` guards the write endpoints (`POST` / `PUT` / `DELETE`); reads stay public.

![Authentication flow](diagrams/authentication.jpg)
...
![CI pipeline](diagrams/ci-pipeline.jpg)
